...
library(this.path)
script_dir <- this.dir()
results_dir <- normalizePath(file.path(script_dir, "..", "results", "2_select_correlation_threshold"), mustWork = FALSE)
figures_dir <- normalizePath(file.path(script_dir, "..", "figures", "2_select_correlation_threshold"), mustWork = FALSE)
...
for (substrate in substrates){
  print(substrate)
  network_path <- file.path(script_dir, "..", "results", "1_filter_asv_table_and_build_sparcc_network")
