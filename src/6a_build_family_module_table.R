...
script_dir <- this.dir()
results_dir <- normalizePath(file.path(script_dir, "..", "results", "6a_build_family_module_table"), mustWork = FALSE)
figures_dir <- normalizePath(file.path(script_dir, "..", "figures", "6a_build_family_module_table"), mustWork = FALSE)
...
setwd(figures_dir)
gtsave(gt_table,path = figures_dir,filename = paste(substrate,"modules_table.html",sep = "_"))
