...
script_dir <- this.dir()
results_dir <- normalizePath(file.path(script_dir, "..", "results", "1_filter_asv_table_and_build_sparcc_network"), mustWork = FALSE)
...
for (i in 4:length(substrates)) {
  ...
  setwd(paste(results_dir,substrate,sep = "/"))
