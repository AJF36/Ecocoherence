...
# --- Select substrate ---
# 
dir.create("../figures/dendograms_strategy_families",showWarnings = F)  
...
dir_path <- file.path(subs_path, "functionink_tmp")
...
setwd(normalizePath("../figures/dendograms_strategy_families"))
