...
script_dir <- this.dir()
figures_dir <- normalizePath(file.path(script_dir, "..", "figures", "4b_test_family_pair_pseudopvalues"), mustWork = FALSE)
...
for (substrate in substrates){
  ...
  net_path <- file.path(script_dir,"..","results","3_filter_network_by_threshold")
