...
script_dir<-this.dir()
results_dir <- normalizePath(file.path(script_dir, "..", "results", "7c_aggregate_module_relative_abundance"), mustWork = FALSE)
producer_dir <- normalizePath(file.path(script_dir, "..", "results", "6c_aggregate_abundance_by_module"), mustWork = FALSE)
